...
class _TripListState extends State<TripList> {
  ...
  void initState() {
    super.initState();
    //waiting until list is ready then add trip
  ...
  void _addTrips() {
    ...
    Future ft = Future(() {});
    //delay on each tile, so list tile isn't animate at same time
    _trips.forEach((Trip trip) {
      ft = ft.then((value) => Future.delayed(Duration(milliseconds: 100), () {
